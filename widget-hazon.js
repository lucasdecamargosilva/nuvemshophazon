(function () {
    ...
    // ===============================================
    const apiKey = "pl_live_c35be20f2533f75025bafcdef2a41bedae130909498c23ab479945b233c002a7";
    window.PROVOU_LEVOU_API_KEY = apiKey;

    const WEBHOOK_PROVA = 'https://n8n.segredosdodrop.com/webhook/gerador-oculos';
    const WEBHOOK_PIX = 'https://n8n.segredosdodrop.com/webhook/hazon-pix';
    const WEBHOOK_PIX_STATUS = 'https://n8n.segredosdodrop.com/webhook/hazon-pix-status';
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/hazon-check-limit';
...
const fd = new FormData();
                    ...
                    console.log('[PL Hazon] Enviando', allProdImgs.length, 'fotos do produto');
